...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/04/13 13:30:55 by user42            #+#    #+#             */
/*   Updated: 2020/04/13 18:35:00 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			*construct_line(char *ts, char *sp,\
char *index, char *action)
{
	int		i;
	char	*buffer;
...
void			print_status(t_global *gl, t_philo *p,\
t_status status, int is_exit)
{
	char			*timestamp;
	char			*space;
	...
	print_line(construct_line(timestamp, space, p_num, action),\
	gl, status, is_exit);
}
